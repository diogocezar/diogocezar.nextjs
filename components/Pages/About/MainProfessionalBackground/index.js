    ...
    <RightContent>
      <ListContainer>
        <ListItem type="orange" link={false}>
          ...
          <ListSubTitle type="orange">2022~NOW / ENGINEER MANAGER</ListSubTitle>
          <ListContent>Managing teams and helping people to rise on professional carreres.</ListContent>
        </ListItem>
        <ListItem type="orange" link={false}>
